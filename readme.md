...
**C01900** | Tile collision checks on layers that don't contain any tiles crash the game | M | | on, off
**C02000** | The game wastes memory by allocating every tile block that touches any zone, whether or not it actually contains any tiles | E | | on, off
